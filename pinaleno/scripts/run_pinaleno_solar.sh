#!/bin/bash
# Run 365-day r.sun solar radiation for Pinaleño + Santa Teresa Mts (10m DEM)
...
echo "Pinaleño Solar Radiation Pipeline"
echo "==================================="
echo "DEM: $DEM (6147x7259, 10m, UTM 12N, 785-3264m)"
